  ...
  return (
    <div className="min-h-screen bg-slate-950 relative overflow-hidden">
      ...
      <div className="relative min-h-screen grid lg:grid-cols-[1.1fr_480px]">
        <section className="hidden lg:flex flex-col justify-between px-12 py-10 border-r border-white/[0.06]">
          <div>
            <Link
              to="/"
              className="inline-flex items-center gap-2.5 text-slate-400 hover:text-slate-200 transition-colors duration-fast"
            >
          ...
          <div className="max-w-xl">
            ...
            <h1 className="text-4xl font-semibold tracking-tight text-slate-100 mb-4">
              {title}
            </h1>
        ...
        <section className="flex items-center justify-center px-6 py-10">
          <div className="w-full max-w-md glass border border-white/[0.08] rounded-2xl p-6 sm:p-7">
            ...
            {footer && (
              <div className="mt-6 pt-5 border-t border-white/[0.06] text-sm text-slate-500">
                {footer}
              </div>
            )}
          </div>
