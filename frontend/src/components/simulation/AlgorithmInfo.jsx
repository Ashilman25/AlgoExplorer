...
export default function AlgorithmInfo({ learningInfo, defaultExpanded = false }) {
  ...
  return (
    <div className = "border-b border-white/[0.05]">
      ...
      <button
        ...
        className = "w-full flex items-center gap-2 px-4 py-2.5 hover:bg-white/[0.02] transition-colors duration-100"
      >
        <ChevronRight
          size = {12}
          className = {cn(
        ...
        />
        <span className = "mono-label">Algorithm Info</span>
      </button>

      {expanded && (
        <div className = "px-4 pb-4 space-y-4 animate-enter">
